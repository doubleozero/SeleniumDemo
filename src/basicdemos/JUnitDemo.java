/**
 *  The JUnitDemo script demonstrates what a basic Selenium JUnit test looks like.
 ...
 *  
 *  This example was created using JUnit 4.
 *  
...
// Note that JUnit does not require a "main" function.
public class JUnitDemo {
	String baseURL = "http://www.demoblaze.com";
	WebDriver driver = new ChromeDriver();

	// Everything within the @Before method executes before each test method.
	@Before
	...
	// Note that the @Test notation is needed in order to execute this script through Taurus.
	// Note that this demo only uses one @Test method.
	@Test
	public void test() {
		driver.get(baseURL);
		...
		// Add the HTC One M9 to the cart:
		try {
	...
	// Everything within the @After method executes after each test method.
	@After
